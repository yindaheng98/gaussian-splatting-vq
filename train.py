...
def training(dataset, opt, pipe, testing_iterations, saving_iterations, load_ply, incremental, debug_from):
    ...
    for iteration in range(first_iter, opt.iterations + 1):
        ...
        if incremental:
            loss_weights = {'rotation': 1.0, 'rigidity': 1.0, 'isometry': 1.0, 'stretch': 1.0}
...
if __name__ == "__main__":
    ...
    training(lp.extract(args), op.extract(args), pp.extract(args), args.test_iterations, args.save_iterations, args.start_ply, args.incremental, args.debug_from)
